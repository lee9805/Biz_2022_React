...
/*
DB에서 데이터들을 fetch 하여 list를 보여줄 예정인데
List 보여주고 다음에 item 을 클릭하거나 변경하는 코드를 추가하려면
어디에서 State 데이터를 만들어야 할 것인가를 고민해야 한다
DietMain 에서 DB fetch 하고 item등을 변화시키는 event 도 선언하여
Main Component 가 감싸고 있는 child Component 들이 공유할 수 있도록
설계를 한다
*/
const DietMain = () => {
  ...
  // 두번째 매개변수를 생략하게 되면useEffect 함수가
